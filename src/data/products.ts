...
const bikeImages = {
  Mountain: [
    ...
    'https://images.unsplash.com/photo-1544191696-102dbdaeeaa0?q=80&w=800&auto=format&fit=crop',
  ],
  Road: [
  ...
  Gravel: [
    'https://images.unsplash.com/photo-1532298229144-0ee0c9e9ad58?q=80&w=800&auto=format&fit=crop',
    'https://images.unsplash.com/photo-1471506480208-8e93acc6c0df?q=80&w=800&auto=format&fit=crop',
  ],
  Electric: [
...
const generateProducts = (): Product[] => {
  ...
  // Initial 6 products for consistency
  items.push(
